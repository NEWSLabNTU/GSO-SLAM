...
// NOTE: opencv2/cudawarping.hpp unavailable in JetPack OpenCV (no CUDA modules).
// CPU cv::resize is used instead.
        ...
        if (do_gaus_pyramid_training) {
            ...
            for (int l = 0; l < num_gaus_pyramid_sub_levels_; ++l) {
                ...
                gaus_pyramid_undistort_mask_[l] =
                    tensor_utils::cvGpuMat2TorchTensor_Float32(undistort_mask_resized);
            }
        }
    }
